            ...
            <div>
                <div class="row settings">
                	<div class="col-4" style={{marginTop: "20px"}}>
                		...
                		<div class="d-flex align-items-center" style={{marginTop: "20px"}}>
                			<Avatar style={{
   								width: "120px",
   								height: "120px"
                        	}} src={tempImg} />
                	...
                	<div class="col-8 d-flex align-items-center" style={{marginTop: "20px"}}>
                		<div class="row">
                			<div class="col-12">
                				<h2>Names</h2>
                			</div>
                			...
                			<div class="col-12">
                				<button class="btn btn-primary btn-block" style={{marginTop: "30px"}}>Submit Changes</button>
                			</div>
                		</div>
                	</div>
                	<div class="col-12" style={{marginTop: "50px"}}>
                		...
                		<TextField
				          ...
				          style={{width: "100%", border: "1px solid #d8d8d8", padding: "10px", borderRadius: "10px"}}
				        />
                	</div>
                </div>
            </div>
